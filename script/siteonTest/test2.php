<?php
$url = "http://moveplus.co.uk/"; //The Url of the site - the last '/' is needed

$root_dir = '../..'; //Where the root of the site is with relation to this file.

$file_mask = '*.twig'; //Or *.html or whatever - Any pattern that can be used in the glob() php function can be used here.
...
<?php
	...
	<p>
		<strong><?php echo $total_file_count; ?></strong> files were found and indexed.<br />
		Lowest priority of <strong><?php echo $lowest_priority; ?></strong> 
		was given to
			<a href='<?php echo $lowest_priority_page; ?>'><?php echo $lowest_priority_page; ?></a>
	</p>
	...
	<?php } ?>
		...
		<form action="test2.php" method="post">
			Starting Priority : 
			<input type="text" name="starting_priority" size="3" value="<?php echo $starting_priority; ?>" />
